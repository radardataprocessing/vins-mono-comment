...
// in this calss td means the time delay of imu and camera
...
bool ProjectionTdFactor::Evaluate(double const *const *parameters, double *residuals, double **jacobians) const
{
    ...
    // TR is a parameter of rolling shutter camera, corresponding to readout time per line
    // Eigen::Vector3d velocity_i, velocity_j;
    // pts_i and pts_j is the pixel coordinate of the feature point without considering the time delay
    // pts_i_td and pts_j_td takes the time delay into consideration 
    pts_i_td = pts_i - (td - td_i + TR / ROW * row_i) * velocity_i;
    pts_j_td = pts_j - (td - td_j + TR / ROW * row_j) * velocity_j;
    // use a series of transformation relations to project pts_i_td onto the pixel coordinate of jth frame to get the predicted pixel coordinate, and the residual is the
    // difference of predicted coordinate and pts_j_td 
...
#else
        // pixel coordinate's derivative about x,y,z, here dep_j is z
